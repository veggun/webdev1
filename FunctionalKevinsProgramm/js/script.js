...
watchesSum = prompt('Скажи колько стоят эти wonderful часы made of gold plastic and uranium? ') * parseInt(watchesCount)
earringsSum = prompt('Не забудь назвать price этих beautiful сережек, сорванных с голодных african womens') * parseInt(earringsCount)
